...
lv_obj_t * ui_ContainerPageReflow;
lv_obj_t * ui_ReflowTopBar;
lv_obj_t * ui_DropdownReflowProfile;
lv_obj_t * ui_ButtonReflowEdit;
lv_obj_t * ui_LabelReflowEdit;
lv_obj_t * ui_ReflowChart;
lv_obj_t * ui_LabelReflowTempTset;
lv_obj_t * ui_LabelReflowPower;
lv_obj_t * ui_LabelReflowTime;
lv_obj_t * ui_LabelReflowState;
lv_obj_t * ui_ReflowBottomBar;
lv_obj_t * ui_ButtonReflowStart;
lv_obj_t * ui_LabelReflowStart;
lv_obj_t * ui_ButtonReflowPause;
lv_obj_t * ui_LabelReflowPause;
lv_obj_t * ui_ButtonReflowStop;
lv_obj_t * ui_LabelReflowStop;
lv_obj_t * ui_ReflowEditOverlay;
lv_obj_t * ui_ReflowEditPanel;
lv_obj_t * ui_ReflowEditTitle;
lv_obj_t * ui_DropdownReflowEditPoint;
lv_obj_t * ui_LabelReflowEditTime;
lv_obj_t * ui_SliderReflowEditTime;
lv_obj_t * ui_LabelReflowEditTimeValue;
lv_obj_t * ui_LabelReflowEditTemp;
lv_obj_t * ui_SliderReflowEditTemp;
lv_obj_t * ui_LabelReflowEditTempValue;
lv_obj_t * ui_ReflowEditButtons;
lv_obj_t * ui_ButtonReflowEditApply;
lv_obj_t * ui_LabelReflowEditApply;
lv_obj_t * ui_ButtonReflowEditReset;
lv_obj_t * ui_LabelReflowEditReset;
lv_obj_t * ui_ButtonReflowEditCancel;
lv_obj_t * ui_LabelReflowEditCancel;
