...
lv_obj_t * ui_ContainerPageReflowRun;
lv_obj_t * ui_ReflowRunChart;
lv_obj_t * ui_LabelReflowRunHint;
lv_obj_t * ui_LabelReflowRunTempTset;
lv_obj_t * ui_LabelReflowRunPower;
lv_obj_t * ui_LabelReflowRunTime;
lv_obj_t * ui_LabelReflowRunState;
lv_obj_t * ui_ReflowRunBottomBar;
lv_obj_t * ui_ButtonReflowRunSelect;
lv_obj_t * ui_LabelReflowRunSelect;
lv_obj_t * ui_ButtonReflowRunEdit;
lv_obj_t * ui_LabelReflowRunEdit;
lv_obj_t * ui_ButtonReflowRunStart;
lv_obj_t * ui_LabelReflowRunStart;
